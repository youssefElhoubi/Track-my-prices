...
export function EmptyHeart({ className }: { className?: string }) {
    return (
...
export function Logout({ className }: { className?: string }) {
    return (
        <svg width="58" height="58" viewBox="0 0 58 58" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
            <path fill-rule="evenodd" clip-rule="evenodd" d="M14.5 4.83301C12.5772 4.83301 10.7331 5.59685 9.37348 6.95648C8.01384 8.31612 7.25 10.1602 7.25 12.083V45.9163C7.25 47.8392 8.01384 49.6832 9.37348 51.0429C10.7331 52.4025 12.5772 53.1663 14.5 53.1663H29C30.9228 53.1663 32.7669 52.4025 34.1265 51.0429C35.4862 49.6832 36.25 47.8392 36.25 45.9163V12.083C36.25 10.1602 35.4862 8.31612 34.1265 6.95648C32.7669 5.59685 30.9228 4.83301 29 4.83301H14.5ZM39.3747 17.6244C39.8279 17.1714 40.4425 16.9169 41.0833 16.9169C41.7241 16.9169 42.3387 17.1714 42.7919 17.6244L52.4586 27.2911C52.9116 27.7443 53.1661 28.3589 53.1661 28.9997C53.1661 29.6405 52.9116 30.2551 52.4586 30.7083L42.7919 40.3749C42.3361 40.8151 41.7257 41.0587 41.092 41.0532C40.4584 41.0477 39.8523 40.7936 39.4042 40.3455C38.9561 39.8974 38.702 39.2913 38.6965 38.6576C38.6909 38.024 38.9345 37.4135 39.3747 36.9578L44.9162 31.4163H24.1667C23.5257 31.4163 22.911 31.1617 22.4578 30.7085C22.0046 30.2553 21.75 29.6406 21.75 28.9997C21.75 28.3587 22.0046 27.744 22.4578 27.2908C22.911 26.8376 23.5257 26.583 24.1667 26.583H44.9162L39.3747 21.0416C38.9217 20.5884 38.6672 19.9738 38.6672 19.333C38.6672 18.6922 38.9217 18.0776 39.3747 17.6244Z" fill="#D42700" />
        </svg>
