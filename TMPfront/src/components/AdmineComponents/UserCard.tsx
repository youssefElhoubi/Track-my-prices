...
const UserCard: React.FC<users> = ({ id, name, email, role, tier, created_at, accountStatus, Image_url }) => {
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4 flex items-center justify-between shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="hidden md:flex flex-col items-start">
                ...
                <div className="flex items-center mt-1">
                    <span
                        className={`inline-block h-2 w-2 rounded-full mr-2 ${accountStatus === "active" ? "bg-green-500" : "bg-gray-300"
                            }`}
                    ></span>
                    <span className="text-xs text-gray-500 capitalize">{accountStatus}</span>
                </div>
            </div>
